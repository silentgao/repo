...
<?php 
	...
	//require_once("FoursquareAPI.class.php");
        //include(__DIR__.'/FoursquareAPI.class.php');
        
      //  echo getcwd() . '/../../FoursquareAPI.class.php'; 
       // require_once ('../../FoursquareAPI.class.php');
        
       // $root = $_SERVER['DOCUMENT_ROOT'];
        //config..
        //require_once($root . '../../FoursquareAPI.class.php');
        //require_once dirname(dirname(__FILE__)) . './FoursquareAPI.class.php';
        $location = "pavia";
	// Set your client key and secret
	$client_key = "MOOEIMZSDTASXE3FAK3UESCWP4Y2QQJN4ZYO45O1ECZLKHXD"; // Your Client ID
	$client_secret = "XVIP0TH4JVLPUID5LQXN3OT3SWQ00W35FIPFBAC1KSJYDU44"; // Your Client Secret
