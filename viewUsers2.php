...
<body>
 <?php if($flag) : ?>
	<header id="header">
		<hgroup>
			<h1 class="site_title"><a href="#">View Users</a></h1>
		</hgroup>
	...
	<section id="main" class="column">
		...
		<h4 class="alert_info">All registered users informations.</h4>
    ...
    // Set the active mySQL database
		...
		<header><h3>Users Information</h3></header>
				...
				<div class="module_content">
					<div class="message">
					<p><strong><?php echo $count++.". "."User Name: ".$row["username"]."</br>"."Email: ".$row['email']."</br>"."Role: ".$row['role']."</br>" ?></strong></p></div>
