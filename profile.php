...
<body>
 <?php //if (login_check($mysqli) == true) : ?>
	<header id="header">
		<hgroup>
                    <h1 class="site_title"><a href="registrationv2.php">User Profile</a></h1>
		</hgroup>
	...
	<section id="main" class="column">
            ...
            <h4 class="alert_info">User <?php echo $_SESSION['username'];?> Profile Page.</h4>
				...
				<div class="module_content">
						...
						<fieldset>
							<label>User Name</label>
                                                        <input type='text' name='username' id='username' value="<?php echo $na;?>"/>
						</fieldset>
